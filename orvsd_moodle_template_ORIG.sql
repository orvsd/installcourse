-- MySQL dump 10.11
--
-- Host: localhost    Database: orvsd_template
-- ------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='one of these must be set';
...
INSERT INTO `mdl_context` VALUES (1,10,0),(2,50,1),(3,30,2);
/*!40000 ALTER TABLE `mdl_context` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mdl_context_rel`
--
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='context relations, c2 is a parent (or higher) of c1';

--
-- Dumping data for table `mdl_context_rel`
--

LOCK TABLES `mdl_context_rel` WRITE;
/*!40000 ALTER TABLE `mdl_context_rel` DISABLE KEYS */;
INSERT INTO `mdl_context_rel` VALUES (1,2,1),(2,2,2),(3,3,1),(4,3,3);
...
--
-- Dumping data for table `mdl_groups_courses_groupings`
--
...
--
-- Dumping data for table `mdl_groups_courses_groups`
--
...
--
-- Dumping data for table `mdl_groups_groupings`
--
...
--
-- Dumping data for table `mdl_groups_groupings_groups`
--
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Every action is logged as far as possible';
...
-- Dump completed on 2008-01-30 19:47:35
